...
static SPOTLIGHT_HWND: OnceLock<HWND> = OnceLock::new();
...
fn main() -> Result<()> {
    unsafe {
        ...
        let _ = KEYBOARD_HOOK.set(kb_hook);
        let _ = MOUSE_HOOK.set(mouse_hook);
...
unsafe fn update_region(hwnd: HWND, mouse_x: i32, mouse_y: i32, vx: i32, vy: i32, vw: i32, vh: i32) {
